...
public class CharacterUpgradeService : ICharacterUpgradeService
{
    ...
    private Dictionary<string, Material[]> GetMaterials(Character character)
    {
        ...
        return new()
        {
            ...
            { "20+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Green)}", MaterailTypes.Gem, MaterialRarity.Green, 1), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 3), new($"{this.enemies.GetMaterial(character, MaterialRarity.White)}", MaterailTypes.Enemy, MaterialRarity.White, 3), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 20000) } },
            { "40+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Blue)}", MaterailTypes.Gem, MaterialRarity.Blue, 3), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 10), new($"{character.Assets.MiniBoss}", MaterailTypes.Other, MaterialRarity.Violet, 2), new($"{this.enemies.GetMaterial(character, MaterialRarity.White)}", MaterailTypes.Enemy, MaterialRarity.White, 15), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 40000) } },
            { "50+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Blue)}", MaterailTypes.Gem, MaterialRarity.Blue, 6), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 20), new($"{character.Assets.MiniBoss}", MaterailTypes.Other, MaterialRarity.Violet, 4), new($"{this.enemies.GetMaterial(character, MaterialRarity.Green)}", MaterailTypes.Enemy, MaterialRarity.Green, 12), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 60000) } },
            { "60+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Violet)}", MaterailTypes.Gem, MaterialRarity.Violet, 3), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 30), new($"{character.Assets.MiniBoss}", MaterailTypes.Other, MaterialRarity.Violet, 8), new($"{this.enemies.GetMaterial(character, MaterialRarity.Green)}", MaterailTypes.Enemy, MaterialRarity.Green, 18), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 80000) } },
            { "70+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Violet)}", MaterailTypes.Gem, MaterialRarity.Violet, 6), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 45), new($"{character.Assets.MiniBoss}", MaterailTypes.Other, MaterialRarity.Violet, 12), new($"{this.enemies.GetMaterial(character, MaterialRarity.Blue)}", MaterailTypes.Enemy, MaterialRarity.Blue, 12), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 100000) } },
            { "80+", new Material[] { new($"{this.gems.GetMaterial(character, MaterialRarity.Orange)}", MaterailTypes.Gem, MaterialRarity.Orange, 6), new($"{character.Assets!.LocalSpecialty}", MaterailTypes.Other, MaterialRarity.White, 60), new($"{character.Assets.MiniBoss}", MaterailTypes.Other, MaterialRarity.Violet, 20), new($"{this.enemies.GetMaterial(character, MaterialRarity.Blue)}", MaterailTypes.Enemy, MaterialRarity.Blue, 24), new("Mora", MaterailTypes.Other, MaterialRarity.Blue, 120000) } },
        };
    }
}